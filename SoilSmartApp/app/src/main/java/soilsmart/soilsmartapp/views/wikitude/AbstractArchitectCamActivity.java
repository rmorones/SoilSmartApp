package soilsmart.soilsmartapp.views.wikitude;
...
import soilsmart.soilsmartapp.views.BaseMenuActivity;
 ...
 * <p>
 * DISCLAIMER: Provided from Wikitude and then modified
 */
public abstract class AbstractArchitectCamActivity extends BaseMenuActivity implements ArchitectViewHolderInterface {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        final StartupConfiguration config =
    ...
    private int getFeatures() {
        return (hasGeo() ? StartupConfiguration.Features.Geo : 0) |
                (hasIR() ? StartupConfiguration.Features.Tracking2D : 0);
    }
                ...
                public void run() {
                    ...
                    while (lastKnownLocaton == null && !isFinishing()) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                Toast.makeText(AbstractArchitectCamActivity.this,
                                        R.string.location_fetching,
                                        Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    if (lastKnownLocaton != null && !isFinishing()) {
                        poiData = getPoiNodeInfo(lastKnownLocaton);
    ...
    protected abstract JSONArray getPoiNodeInfo(final Location userLocation);
